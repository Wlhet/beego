...
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/wlhet/beego.GoVersion=${go_version[2]:2}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/wlhet/beego.GitBranch=${CURRENT_BRANCH}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/wlhet/beego.BuildTime=$BUILD_TIME"
