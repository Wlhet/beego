...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/wlhet/beego/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/wlhet/beego/orm.GroupPermissions)"`
}
...
var (
	...
	go get -u github.com/wlhet/beego/orm
	...
	go test -v github.com/wlhet/beego/orm
